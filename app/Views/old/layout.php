...
<head>
  ...
  <link rel="icon" href="<?= base_url('assets/img/favicon.')?>'" type="image/x-icon"> <!-- Favicon-->
  <title>IIM</title>
  <!-- Application vendor css url -->
  <link rel="stylesheet" href="<?= base_url('assets/cssbundle/daterangepicker.min.css')?>">
  <!-- project css file  -->
  ...
  <div class="sidebar p-2 py-md-3 @@cardClass">
    <div class="container-fluid">
      ...
      <div class="title-text d-flex align-items-center mb-4 mt-1">
        <h4 class="sidebar-title mb-0 flex-grow-1"><span>IIM Admin</span></h4>
        ...
        <ul class="menu-list">
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse show" id="my_dashboard">
              <li><a class="ms-link active" href="offline_registration">Offline Registration</a></li>
              <li><a class="ms-link" href="member_import">Member Import</a></li>
              <li><a class="ms-link" href="index-iot.html">Amount Settings</a></li>
            </ul>
          </li>
          <!-- <li class="collapsed">
